(function() {
    ...
    function _snow(_array){
        ...
        this.parent = document.getElementById('snow-place');
        ...
        this.maxLeft = this.parent.offsetWidth - this.size;
        this.maxTop = this.parent.offsetHeight - this.size;
            ...
            var a = [];
                m = setInterval(function(){
                    ...
                    for(var e = _height().top, n = _l(), s_num = a.length - 1;s_num >= 0;s_num--){
                        if(a[s_num]){
                            if(a[s_num].top < e || a[s_num].top + a[s_num].size + 5 > a[s_num].parent.offsetTop + a[s_num].parent.offsetHeight ){
                                a[s_num]._remove();
                                a[s_num] = null;
                                a.splice(s_num,1);
                            } else {
